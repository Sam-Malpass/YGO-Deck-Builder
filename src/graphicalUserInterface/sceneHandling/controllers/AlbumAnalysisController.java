...
public class AlbumAnalysisController implements Initializable {
    ...
    private void getOverviewData() {
        numSpells = ProgramFunctions.getUtilities().getFilter().filterSpells(album.getCards()).size();
        numTraps = ProgramFunctions.getUtilities().getFilter().filterTraps(album.getCards()).size();
        numMonsters = ProgramFunctions.getUtilities().getFilter().filterMonsters(album.getCards()).size();
        ...
        overviewText.appendText("Name: " + album.getContainerName() + "\n");
        ...
        overviewText.appendText("TOTAL CARDS: " + album.getCards().size() + "\n");
    }
    /**
    ...
    private void getSpellData() {
        int numField = ProgramFunctions.getUtilities().getFilter().filterSpellType(album.getCards(), SpellType.FIELD).size();
        int numQuick = ProgramFunctions.getUtilities().getFilter().filterSpellType(album.getCards(), SpellType.QUICK_PLAY).size();
        int numNorm = ProgramFunctions.getUtilities().getFilter().filterSpellType(album.getCards(), SpellType.NORMAL).size();
        int numRit = ProgramFunctions.getUtilities().getFilter().filterSpellType(album.getCards(), SpellType.RITUAL).size();
        int numCont = ProgramFunctions.getUtilities().getFilter().filterSpellType(album.getCards(), SpellType.CONTINUOUS).size();
        int numEqu = ProgramFunctions.getUtilities().getFilter().filterSpellType(album.getCards(), SpellType.EQUIP).size();
        ObservableList<PieChart.Data> pieChartData =
                FXCollections.observableArrayList(
    ...
    private void getTrapData() {
        int numNorm = ProgramFunctions.getUtilities().getFilter().filterTrapType(album.getCards(), TrapType.NORMAL).size();
        int numCont = ProgramFunctions.getUtilities().getFilter().filterTrapType(album.getCards(), TrapType.CONTINUOUS).size();
        int numCount = ProgramFunctions.getUtilities().getFilter().filterTrapType(album.getCards(),TrapType.COUNTER).size();
        ObservableList<PieChart.Data> pieChartData =
                FXCollections.observableArrayList(
    ...
    private void getMonsterData() {
        int numFusion = ProgramFunctions.getUtilities().getFilter().filterFusions(album.getCards()).size();
        int numSynchro = ProgramFunctions.getUtilities().getFilter().filterSynchros(album.getCards()).size();
        int numXYZ = ProgramFunctions.getUtilities().getFilter().filterXYZs(album.getCards()).size();
        int numPend = ProgramFunctions.getUtilities().getFilter().filterPendulums(album.getCards()).size();
        int numRit = ProgramFunctions.getUtilities().getFilter().filterRituals(album.getCards()).size();
        int numEffect = ProgramFunctions.getUtilities().getFilter().filterEffects(album.getCards()).size() - numFusion - numSynchro - numXYZ - numPend - numRit;
        int numNormal = ProgramFunctions.getUtilities().getFilter().filterMonsters(album.getCards()).size() - numFusion - numSynchro - numXYZ - numPend - numEffect - numRit;
        ...
        ArrayList<MonsterCard> monsterCards = ProgramFunctions.getUtilities().getFilter().filterMonsters(album.getCards());
